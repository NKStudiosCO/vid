...
a.hub.removeChild(a.full),a.initStartHub(),a.isIntro=!1)},initStartHub:function(){this.full=document.createElement("div");this.full.style.cssText="position:absolute; top:10px; left:50%; margin-left:-150px; width:300px; height:300px; pointer-events:none;";this.full.id="fullStart";this.hub.appendChild(this.full);var a=this.addButton(this.full,"Play",[276,48,40],"position:absolute; top:10px; left:0px;"),z=this.addButton(this.full,"Multiplayer",[276,48,40],"position:absolute; top:80px; left:0px;"),b=this.addButton(this.full,"New Map",[120,26,22],"position:absolute; top:270px; left:0px;"),
c=this.addButton(this.full,"Terraform",[120,26,22],"position:absolute; top:270px; right:0px;"),e=this.addButton(this.full,"Load",[276,26,22],"position:absolute; top:150px; left:0px;");this.addSelector("DIFFICULTY",["LOW","MEDIUM","HARD"],setDifficulty,0);a.addEventListener("click",function(a){a.preventDefault();playMap()},!1);b.addEventListener("click",function(a){a.preventDefault();newMap()},!1);c.addEventListener("click",function(a){a.preventDefault();newHeightMap()},!1);e.addEventListener("click",
...
function(a){a.preventDefault();getBudjet()},!1);this.addButton(this.hub,"Utilities",[75,16,14],"position:absolute; left:510px; top:-7px; font-weight:bold;",!0).addEventListener("click",
function(a){a.preventDefault();getBudjet()},!1);this.addButton(this.hub,"Menu",[75,16,14],"position:absolute; left:610px; top:-7px; font-weight:bold;",!0).addEventListener("click",
function(a){a.preventDefault();openExit()},!1);this.addButton(this.hub,"Eval",[75,16,14],"position:absolute; left:110px; top:-7px; font-weight:bold;",!0).addEventListener("click",function(a){a.preventDefault();getEval()},!1);this.addButton(this.hub,"Options",[75,16,14],"position:absolute; left:310px; top:-7px; font-weight:bold;",!0).addEventListener("click",function(b){b.preventDefault();a.openExit()},!1);this.addButton(this.hub,"Editor",[75,16,14],"position:absolute; left:410px; top:-7px; font-weight:bold;",
